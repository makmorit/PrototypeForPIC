...
SOURCEFILES_QUOTED_IF_SPACED=sources/device.c sources/i2c.c sources/i2c_lcd.c sources/main.c sources/process.c sources/timer0.c sources/uart.c sources/STTS751.c sources/M25PX16.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/sources/device.p1 ${OBJECTDIR}/sources/i2c.p1 ${OBJECTDIR}/sources/i2c_lcd.p1 ${OBJECTDIR}/sources/main.p1 ${OBJECTDIR}/sources/process.p1 ${OBJECTDIR}/sources/timer0.p1 ${OBJECTDIR}/sources/uart.p1 ${OBJECTDIR}/sources/STTS751.p1 ${OBJECTDIR}/sources/M25PX16.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/sources/device.p1.d ${OBJECTDIR}/sources/i2c.p1.d ${OBJECTDIR}/sources/i2c_lcd.p1.d ${OBJECTDIR}/sources/main.p1.d ${OBJECTDIR}/sources/process.p1.d ${OBJECTDIR}/sources/timer0.p1.d ${OBJECTDIR}/sources/uart.p1.d ${OBJECTDIR}/sources/STTS751.p1.d ${OBJECTDIR}/sources/M25PX16.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/sources/device.p1 ${OBJECTDIR}/sources/i2c.p1 ${OBJECTDIR}/sources/i2c_lcd.p1 ${OBJECTDIR}/sources/main.p1 ${OBJECTDIR}/sources/process.p1 ${OBJECTDIR}/sources/timer0.p1 ${OBJECTDIR}/sources/uart.p1 ${OBJECTDIR}/sources/STTS751.p1 ${OBJECTDIR}/sources/M25PX16.p1

# Source Files
SOURCEFILES=sources/device.c sources/i2c.c sources/i2c_lcd.c sources/main.c sources/process.c sources/timer0.c sources/uart.c sources/STTS751.c sources/M25PX16.c
...
${OBJECTDIR}/sources/M25PX16.p1: sources/M25PX16.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/sources" 
	@${RM} ${OBJECTDIR}/sources/M25PX16.p1.d 
	@${RM} ${OBJECTDIR}/sources/M25PX16.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --opt=+asm,+asmfile,-speed,+space,-debug,-local --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-osccal,-resetbits,-download,-stackcall,+clib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/sources/M25PX16.p1  sources/M25PX16.c 
	@-${MV} ${OBJECTDIR}/sources/M25PX16.d ${OBJECTDIR}/sources/M25PX16.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/sources/M25PX16.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
