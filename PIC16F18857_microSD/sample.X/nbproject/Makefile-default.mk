...
SOURCEFILES_QUOTED_IF_SPACED=sources/device.c sources/i2c.c sources/i2c_lcd.c sources/main.c sources/process.c sources/timer0.c sources/uart.c sources/STTS751.c sources/sdcard.c sources/sdcard_test.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/sources/device.p1 ${OBJECTDIR}/sources/i2c.p1 ${OBJECTDIR}/sources/i2c_lcd.p1 ${OBJECTDIR}/sources/main.p1 ${OBJECTDIR}/sources/process.p1 ${OBJECTDIR}/sources/timer0.p1 ${OBJECTDIR}/sources/uart.p1 ${OBJECTDIR}/sources/STTS751.p1 ${OBJECTDIR}/sources/sdcard.p1 ${OBJECTDIR}/sources/sdcard_test.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/sources/device.p1.d ${OBJECTDIR}/sources/i2c.p1.d ${OBJECTDIR}/sources/i2c_lcd.p1.d ${OBJECTDIR}/sources/main.p1.d ${OBJECTDIR}/sources/process.p1.d ${OBJECTDIR}/sources/timer0.p1.d ${OBJECTDIR}/sources/uart.p1.d ${OBJECTDIR}/sources/STTS751.p1.d ${OBJECTDIR}/sources/sdcard.p1.d ${OBJECTDIR}/sources/sdcard_test.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/sources/device.p1 ${OBJECTDIR}/sources/i2c.p1 ${OBJECTDIR}/sources/i2c_lcd.p1 ${OBJECTDIR}/sources/main.p1 ${OBJECTDIR}/sources/process.p1 ${OBJECTDIR}/sources/timer0.p1 ${OBJECTDIR}/sources/uart.p1 ${OBJECTDIR}/sources/STTS751.p1 ${OBJECTDIR}/sources/sdcard.p1 ${OBJECTDIR}/sources/sdcard_test.p1

# Source Files
SOURCEFILES=sources/device.c sources/i2c.c sources/i2c_lcd.c sources/main.c sources/process.c sources/timer0.c sources/uart.c sources/STTS751.c sources/sdcard.c sources/sdcard_test.c
